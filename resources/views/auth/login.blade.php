            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group d-flex flex-md-row flex-column justify-content-between align-items-center">
                  ...
                  <div class="text-right"><a href="auth-forgot-password.html" class="card-link"><small>Perdiste tu
                        Contaseña?</small></a></div>
                </div>
                <button type="submit" class="btn btn-primary glow w-100 position-relative">Entrar<i id="icon-arrow"
                    class="bx bx-right-arrow-alt"></i></button>
              </form>
              <hr>
              <div class="text-center"><small class="mr-25">Todavia no te registraste? registrate aca</small><a
                  href="/register"><small>Registrate</small></a></div>
            </div>
          </div>
        </div>
        <!-- right section image -->
