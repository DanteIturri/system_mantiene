          ...
          <div class="col-md-6 col-12 px-0">
            ...
            <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
              ...
              <div class="card-body">
                ...
                <div class="divider">
                  <div class="divider-text text-uppercase text-muted"><small>O logueate
                      con tu Email</small>
                  </div>
                </div>
                  ...
                  <div class="form-group d-flex flex-md-row flex-column justify-content-between align-items-center">
                    <div class="text-left">
                      <div class="checkbox checkbox-sm">
                        ...
                        <label class="checkboxsmall" for="exampleCheck1"><small>Recuerdame
                          </small></label>
                      </div>
                    </div>
                    <div class="text-right"><a href="auth-forgot-password.html" class="card-link"><small>Perdiste tu Contaseña?</small></a></div>
                  </div>
                  <button type="submit" class="btn btn-primary glow w-100 position-relative">Entrar<i id="icon-arrow"
                      class="bx bx-right-arrow-alt"></i></button>
                </form>
                <hr>
                <div class="text-center"><small class="mr-25">Todavia no te registraste? registrate aca</small><a href="auth-register.html"><small>Registrate</small></a></div>
              </div>
            </div>
          </div>
          <!-- right section image -->
