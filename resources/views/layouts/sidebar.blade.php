...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main " id="main-menu-navigation" data-menu="menu-navigation"
      ...
      <li id="menu_sub" class=" nav-item"><a class=" nav-link " href="#"><i class='bx bx-desktop bx-sm'></i><span
            class="menu-title text-truncate" data-i18n="">
            <span class="menu-item text-truncate" data-i18n="nav.sk_starter_kit.2_columns">
              Administracion
            </span></a>
        <ul class="menu-content">

          <li class="active"><a class="d-flex align-items-center nav-link" href="/clients"><i
                class='bx bx-user '></i><span class="menu-item text-truncate "
                data-i18n="nav.sk_starter_kit.2_columns">Clientes</span>
            </a>
          </li>
          <li class="active"><a class="d-flex align-items-center nav-link" href="/users"><i
                class='bx bxs-user '></i><span class="menu-item text-truncate "
                data-i18n="nav.sk_starter_kit.2_columns">Usuarios</span></a>
          </li>
          <li class="active"><a class="d-flex align-items-center nav-link" href="/branches"><i
                class='bx bx-buildings '></i><span class="menu-item text-truncate "
                data-i18n="nav.sk_starter_kit.2_columns">Sucursales</span></a>
          </li>
          <li class="active"><a class="d-flex align-items-center nav-link" href="/roles">
              <i class='bx bxs-user-voice '></i><span class="menu-item text-truncate "
                data-i18n="nav.sk_starter_kit.2_columns">Roles</span>
            </a>
          </li>
